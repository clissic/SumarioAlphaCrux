...
window.SUMARIO = {
  meta: {
    ...
    fechaOficio: "4 de septiembre de 2026",
  ...
  introduccion:
    "Me dirijo a Ud. a efectos de elevar las actuaciones realizadas hasta la fecha en relación con el hundimiento del buque «Alpha Crux», N° OMI 9024621, bandera rusa, ocurrido el 25 de agosto de 2026 en el Muelle B, hangar 7, del Puerto de Montevideo. El presente constituye un borrador de respuesta a la investigación, elaborado sobre la base de las catorce actas de información sumaria tomadas —incluida la del inspector técnico Kibong MOON del 4 de septiembre—, el informe del Oficial Comandante de Guardia, el informe del supervisor de CONMO, la exposición del Práctico de Seguridad, la nota de cronología, los planos del buque, el rol de tripulación y los datos meteorológicos de viento. Quedan diligencias pendientes cuya práctica puede modificar, confirmar o descartar las conclusiones provisorias que se formulan.",
  ...
  analisisActas: [
    ...
    },
    {
      ...
      texto: "Park KWANG JUN sitúa a personal venido de Corea soldando a las 16:00. Kibong MOON niega personal de tierra y sitúa la soldadura en cubierta ejecutada por tripulantes con habilitación pedida a la agencia. La contradicción queda abierta."
    },
    {
      titulo: "Sobre la guardia de puente y el aviso de las 18:46",
      texto: "El patrón situó a Kyongsu PARK de guardia; PARK lo niega. URRESTARAZU sitúa el aviso a la agencia en MOON (18:55); MOON confirma retiro 17:10 y retorno 19:00. Falta ampliar a MOON sobre el mensaje."
    },
    {
  ...
  deficiencias: [
    ...
    "Ningún registro objetivo de la fase crítica incorporado al expediente: sin CCTV, sin grabaciones de CONMO contrastadas, sin tráfico VHF, sin registros telefónicos de la agencia ni de SAAM. Sí se incorporaron planos del buque, el rol de tripulación, la serie de viento Telemetry+ y el acta de MOON."
  ],
  ...
  conclusiones: [
    ...
    "Subsisten contradicciones centrales —orden de no encender la bomba, dirección del trasvase, contenido del aviso 18:55, personal coreano de tierra— cuya resolución requiere a TOKMIN, ampliación a MOON y careos.",
